CineVOSchema = GraphQL::Schema.define do
...
module RelaySchemaHelpers
  ...
  def execute_introspection_query
    ...
    Rails.cache.fetch checksum do
      CineVOSchema.execute GraphQL::Introspection::INTROSPECTION_QUERY
    end
  end
  ...
  def dump_schema
    ...
    result = JSON.pretty_generate(CineVOSchema.execute_introspection_query)
...
CineVOSchema.extend RelaySchemaHelpers
